...
void PDMA_SetTransferMode(uint32_t u32Ch, uint32_t u32Peripheral, uint32_t u32ScatterEn, uint32_t u32DescAddr)
{
    ...
    switch(u32Ch)
    {
        ...
        case 7:
            ...
            break;
        case 8:
            PDMA->REQSEL8_9 = (PDMA->REQSEL8_9 & ~PDMA_REQSEL8_9_REQSRC8_Msk) | u32Peripheral;
            break;
        case 9:
            PDMA->REQSEL8_9 = (PDMA->REQSEL8_9 & ~PDMA_REQSEL8_9_REQSRC9_Msk) | (u32Peripheral << PDMA_REQSEL8_9_REQSRC9_Pos);
        default:
            ;
    }
