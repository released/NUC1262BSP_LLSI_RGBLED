...
# 10 "../../../Library/StdDriver/src/uart.c" 2
...
# 39 "../../../Library/StdDriver/src/uart.c"
void UART_ClearIntFlag(UART_T* uart, uint32_t u32InterruptFlag)
{

    if(u32InterruptFlag & (0x1ul << (10)))
        uart->FIFOSTS = (0x1ul << (6)) | (0x1ul << (5)) | (0x1ul << (5)) | (0x1ul << (3));
...
# 66 "../../../Library/StdDriver/src/uart.c"
void UART_Close(UART_T* uart)
{
    uart->INTEN = 0;
}
# 81 "../../../Library/StdDriver/src/uart.c"
void UART_DisableFlowCtrl(UART_T* uart)
{
...
# 137 "../../../Library/StdDriver/src/uart.c"
void UART_EnableFlowCtrl(UART_T* uart)
{
...
# 169 "../../../Library/StdDriver/src/uart.c"
void UART_EnableInt(UART_T* uart, uint32_t u32InterruptFlag)
{
...
void UART_Open(UART_T* uart, uint32_t u32baudrate)
{
    ...
    uint32_t au32ClkTbl[4] = {(12000000UL), 0, (32768UL), ((48000000UL)>>1)};
    uint32_t u32Baud_Div = 0;


    switch((uint32_t)uart)
    {
        case ((( uint32_t)0x40000000) + 0x50000):
        ...
        case ((( uint32_t)0x40100000) + 0x50000):
            u8UartClkSrcSel = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL1 & (0x3ul << (26))) >> (26);
            u8UartClkDivNum = (((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV0 & (0xful << (12))) >> (12);
            break;
    }
    ...
    if(u32baudrate != 0)
    {
        ...
        if(u32Baud_Div > 0xFFFF)
            uart->BAUD = ((0) | (((((au32ClkTbl[u8UartClkSrcSel]) / (u8UartClkDivNum + 1)) + ((u32baudrate)*8)) / (u32baudrate) >> 4)-2));
        else
            uart->BAUD = (((0x1ul << (29)) | (0x1ul << (28))) | u32Baud_Div);
    }
}
# 256 "../../../Library/StdDriver/src/uart.c"
uint32_t UART_Read(UART_T* uart, uint8_t *pu8RxBuf, uint32_t u32ReadBytes)
{
...
# 304 "../../../Library/StdDriver/src/uart.c"
void UART_SetLine_Config(UART_T* uart, uint32_t u32baudrate, uint32_t u32data_width, uint32_t u32parity, uint32_t u32stop_bits)
{
    uint8_t u8UartClkSrcSel, u8UartClkDivNum;
    uint32_t au32ClkTbl[4] = {(12000000UL), 0, (32768UL), ((48000000UL)>>1)};
...
# 357 "../../../Library/StdDriver/src/uart.c"
void UART_SetTimeoutCnt(UART_T* uart, uint32_t u32TOC)
{
...
# 380 "../../../Library/StdDriver/src/uart.c"
void UART_SelectIrDAMode(UART_T* uart, uint32_t u32Buadrate, uint32_t u32Direction)
{
    uint8_t u8UartClkSrcSel, u8UartClkDivNum;
    uint32_t au32ClkTbl[4] = {(12000000UL), 0, (32768UL), ((48000000UL)>>1)};
    ...
    {
        uart->IRDA |= (0x1ul << (6)); //Rx signal is inverse
        uart->IRDA &= ~(0x1ul << (1));
    }
    else
    {
        uart->IRDA &= ~(0x1ul << (5)); //Tx signal is not inverse
        uart->IRDA |= (0x1ul << (1));
    }

}
# 448 "../../../Library/StdDriver/src/uart.c"
void UART_SelectRS485Mode(UART_T* uart, uint32_t u32Mode, uint32_t u32Addr)
{
...
# 470 "../../../Library/StdDriver/src/uart.c"
uint32_t UART_Write(UART_T* uart, uint8_t *pu8TxBuf, uint32_t u32WriteBytes)
{
    uint32_t u32Count, u32delayno;
