...
# 75 "../../../Library/StdDriver/src/clk.c"
void CLK_PowerDown(void)
{
...
# 94 "../../../Library/StdDriver/src/clk.c"
void CLK_Idle(void)
{
...
# 197 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_SetCoreClock(uint32_t u32Hclk)
{
    uint32_t u32HIRCSTB;
...
# 258 "../../../Library/StdDriver/src/clk.c"
void CLK_SetHCLK(uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
    uint32_t u32HIRCSTB;
...
# 353 "../../../Library/StdDriver/src/clk.c"
void CLK_SetModuleClock(uint32_t u32ModuleIdx, uint32_t u32ClkSrc, uint32_t u32ClkDiv)
{
...
# 388 "../../../Library/StdDriver/src/clk.c"
void CLK_SetSysTickClockSrc(uint32_t u32ClkSrc)
{
...
# 420 "../../../Library/StdDriver/src/clk.c"
void CLK_DisableXtalRC(uint32_t u32ClkMask)
{
    ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PWRCTL &= ~u32ClkMask;
}
# 470 "../../../Library/StdDriver/src/clk.c"
void CLK_EnableModuleClock(uint32_t u32ModuleIdx)
{
...
# 522 "../../../Library/StdDriver/src/clk.c"
void CLK_DisableModuleClock(uint32_t u32ModuleIdx)
{
    uint32_t u32ClkTbl[3] = {0x0, 0x4, 0x2C};
...
uint32_t CLK_EnablePLL(uint32_t u32PllClkSrc, uint32_t u32PllFreq)
{
    ...
    if((u32PllFreq <= 500000000) && (u32PllFreq > 200000000))
    {
        u32NO = 0;
    }
    else if((u32PllFreq <= 200000000) && (u32PllFreq > 100000000))
    {
        u32NO = 1;
...
lexit:
    ...
    if(u32PllClkSrc == 0x00000000UL)
        ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCTL = (0x00000000UL | (((2)-2)<<9) | ((48)-2) | 0x4000UL);
    else
        ((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->PLLCTL = (0x00080000UL | (((2)-2)<<9) | ((24)-2) | 0x4000UL);
...
# 681 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_WaitClockReady(uint32_t u32ClkMask)
{
...
# 708 "../../../Library/StdDriver/src/clk.c"
void CLK_EnableSysTick(uint32_t u32ClkSrc, uint32_t u32Count)
{
...
uint32_t CLK_GetModuleClockSource(uint32_t u32ModuleIdx)
{
    ...
    if((((u32ModuleIdx) >>25) & 0x7) != 0x0)
    {
        ...
        u32TmpAddr = (uint32_t)&((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKSEL0 + (au32SelTbl[(((u32ModuleIdx) >>28) & 0x3)]);
...
# 790 "../../../Library/StdDriver/src/clk.c"
uint32_t CLK_GetModuleClockDivider(uint32_t u32ModuleIdx)
{
    uint32_t u32TmpVal = 0UL, u32TmpAddr = 0UL;
    ...
    if((((u32ModuleIdx) >>10) & 0xff) != 0x0)
    {
        ...
        u32TmpAddr = (uint32_t)&((CLK_T *) ((( uint32_t)0x50000000) + 0x00200))->CLKDIV0 + (au32DivTbl[(((u32ModuleIdx) >>18) & 0x3)]);
