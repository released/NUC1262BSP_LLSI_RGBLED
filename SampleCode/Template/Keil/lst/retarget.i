...
# 43 "../../../Library/StdDriver/src/retarget.c"
FILE __stdout;
FILE __stdin;
...
# 187 "../../../Library/StdDriver/src/retarget.c"
...
{
    uint32_t *sp;
# 206 "../../../Library/StdDriver/src/retarget.c"
        if(lr & 4UL)
        {
            sp = (uint32_t *)psp;
        }
...
# 228 "../../../Library/StdDriver/src/retarget.c"
    printf("  HardFault!\n\n");
# 243 "../../../Library/StdDriver/src/retarget.c"
    while(1U|*sp){}
...
# 267 "../../../Library/StdDriver/src/retarget.c"
void SendChar_ToUART(int ch)
{
    if((char)ch == '\n')
    {
    ...
    while(((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FIFOSTS & (0x1ul << (23))) {}
    ((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->DAT = (uint32_t)ch;
}
# 345 "../../../Library/StdDriver/src/retarget.c"
void SendChar(int ch)
{
# 376 "../../../Library/StdDriver/src/retarget.c"
    SendChar_ToUART(ch);

}
# 389 "../../../Library/StdDriver/src/retarget.c"
char GetChar(void)
{
# 427 "../../../Library/StdDriver/src/retarget.c"
    while(1)
    {
        if((((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->FIFOSTS & (0x1ul << (14))) == 0U)
        {
            return ((char)((UART_T *) ((( uint32_t)0x40000000) + 0x50000))->DAT);
        }
    }
...
# 479 "../../../Library/StdDriver/src/retarget.c"
void _ttywrch(int ch)
{
    SendChar(ch);
    return;
}
# 504 "../../../Library/StdDriver/src/retarget.c"
int fputc(int ch, FILE *stream)
{
    (void)stream;
    SendChar(ch);
...
# 576 "../../../Library/StdDriver/src/retarget.c"
int ferror(FILE *stream)
{
    (void)stream;
    return (-1);
