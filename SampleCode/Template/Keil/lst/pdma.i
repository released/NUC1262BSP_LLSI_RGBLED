...
# 11 "../../../Library/StdDriver/src/pdma.c"
...
# 12 "../../../Library/StdDriver/src/pdma.c" 2


static uint8_t u32ChSelect[10];
# 38 "../../../Library/StdDriver/src/pdma.c"
void PDMA_Open(uint32_t u32Mask)
{
    uint32_t i;
    ...
    for(i = 0UL; i < 10; i++)
    {
        if((1 << i) & u32Mask)
        {
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[i].CTL = 0UL;
   u32ChSelect[i] = 0UL;
        }
    }

    ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->CHCTL |= u32Mask;
}
# 63 "../../../Library/StdDriver/src/pdma.c"
void PDMA_Close(void)
{
    ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->CHCTL = 0;
}
# 82 "../../../Library/StdDriver/src/pdma.c"
void PDMA_SetTransferCnt(uint32_t u32Ch, uint32_t u32Width, uint32_t u32TransCount)
{
    ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].CTL &= ~((0x3ffful << (16)) | (0x3ul << (12)));
    ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].CTL |= (u32Width | ((u32TransCount - 1) << (16)));
}
# 105 "../../../Library/StdDriver/src/pdma.c"
void PDMA_SetTransferAddr(uint32_t u32Ch, uint32_t u32SrcAddr, uint32_t u32SrcCtrl, uint32_t u32DstAddr, uint32_t u32DstCtrl)
{
    ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].SA = u32SrcAddr;
    ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].DA = u32DstAddr;
    ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].CTL &= ~((0x3ul << (8)) | (0x3ul << (10)));
    ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].CTL |= (u32SrcCtrl | u32DstCtrl);
}
# 157 "../../../Library/StdDriver/src/pdma.c"
void PDMA_SetTransferMode(uint32_t u32Ch, uint32_t u32Peripheral, uint32_t u32ScatterEn, uint32_t u32DescAddr)
{
    ...
    {
        case 0:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL0_3 = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL0_3 & ~(0x3ful << (0))) | u32Peripheral;
            break;
        case 1:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL0_3 = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL0_3 & ~(0x3ful << (8))) | (u32Peripheral << (8));
            break;
        case 2:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL0_3 = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL0_3 & ~(0x3ful << (16))) | (u32Peripheral << (16));
            break;
        case 3:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL0_3 = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL0_3 & ~(0x3ful << (24))) | (u32Peripheral << (24));
            break;
        case 4:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL4_7 = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL4_7 & ~(0x3ful << (0))) | u32Peripheral;
            break;
        case 5:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL4_7 = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL4_7 & ~(0x3ful << (8))) | (u32Peripheral << (8));
            break;
        case 6:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL4_7 = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL4_7 & ~(0x3ful << (16))) | (u32Peripheral << (16));
            break;
        case 7:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL4_7 = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL4_7 & ~(0x3ful << (24))) | (u32Peripheral << (24));
            break;
        case 8:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL8_9 = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL8_9 & ~(0x3ful << (0))) | u32Peripheral;
            break;
        case 9:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL8_9 = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->REQSEL8_9 & ~(0x3ful << (8))) | (u32Peripheral << (8));
        default:
            ;
    }
    ...
    if(u32ScatterEn)
    {
        ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].CTL = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].CTL & ~(0x3ul << (0))) | 0x00000002UL;
        ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].FIRST = u32DescAddr - (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->SCATBA);
    }
    else
        ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].CTL = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].CTL & ~(0x3ul << (0))) | 0x00000001UL;
}
# 225 "../../../Library/StdDriver/src/pdma.c"
void PDMA_SetBurstType(uint32_t u32Ch, uint32_t u32BurstType, uint32_t u32BurstSize)
{
    ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].CTL &= ~((0x1ul << (2)) | (0x7ul << (4)));
    ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].CTL |= (u32BurstType | u32BurstSize);
}
# 241 "../../../Library/StdDriver/src/pdma.c"
void PDMA_EnableTimeout(uint32_t u32Mask)
{
    ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->TOUTEN |= u32Mask;
}
# 256 "../../../Library/StdDriver/src/pdma.c"
void PDMA_DisableTimeout(uint32_t u32Mask)
{
    ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->TOUTEN &= ~u32Mask;
}
# 273 "../../../Library/StdDriver/src/pdma.c"
void PDMA_SetTimeOut(uint32_t u32Ch, uint32_t u32OnOff, uint32_t u32TimeOutCnt)
{
    switch(u32Ch)
    {
        case 0:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->TOC0_1 = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->TOC0_1 & ~(0xfffful << (0))) | u32TimeOutCnt;
            break;
        case 1:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->TOC0_1 = (((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->TOC0_1 & ~(0xfffful << (16))) | (u32TimeOutCnt << (16));
            break;
    ...
    if(u32OnOff)
        ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->TOUTEN |= (1 << u32Ch);
    else
        ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->TOUTEN &= ~(1 << u32Ch);
}
# 302 "../../../Library/StdDriver/src/pdma.c"
void PDMA_Trigger(uint32_t u32Ch)
{
    if(u32ChSelect[u32Ch] == 0UL)
        ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->SWREQ = (1 << u32Ch);
}
# 322 "../../../Library/StdDriver/src/pdma.c"
void PDMA_EnableInt(uint32_t u32Ch, uint32_t u32Mask)
{
    switch(u32Mask)
    {
        case 0x00000000UL:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->INTEN |= (1 << u32Ch);
            break;
        case 0x00000001UL:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->DSCT[u32Ch].CTL &= ~(0x1ul << (7));
            break;
        case 0x00000002UL:
            ((PDMA_T *) ((( uint32_t)0x50000000) + 0x08000))->TOUTIEN |= (1 << u32Ch);
            break;
...
# 356 "../../../Library/StdDriver/src/pdma.c"
void PDMA_DisableInt(uint32_t u32Ch, uint32_t u32Mask)
{
    switch(u32Mask)
    {
