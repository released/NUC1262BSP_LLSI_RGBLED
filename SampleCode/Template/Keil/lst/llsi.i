# 1 "../../../Library/StdDriver/src/llsi.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 357 "<built-in>" 3
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "../../../Library/StdDriver/src/llsi.c" 2
# 10 "../../../Library/StdDriver/src/llsi.c"
...
# 11 "../../../Library/StdDriver/src/llsi.c" 2
...
# 53 "../../../Library/StdDriver/src/llsi.c"
               ...
               uint32_t u32IDOS)
{
    ...
    else
    {
        ...
        {
            llsi->CLKDIV = (llsi->CLKDIV & (~(0xfful << (0)))) | (u32Div << (0));
        }
    }

    u32Period = ((u32ClkSrc * 10) / 1000000 * u32TransferTimeNsec / 1000 / (u32Div + 1) + 5) / 10;
    if(u32Period > 0xFF)
    {
        u32Period = 0xFF;
        llsi->PERIOD |= (0xfful << (0));
    }
    else
    {
        llsi->PERIOD = (llsi->PERIOD & (~(0xfful << (0)))) | (u32Period << (0));
    }

    u32T0H = ((u32ClkSrc * 10) / 1000000 * u32T0HTimeNsec / 1000 / (u32Div + 1) + 5) / 10;
    if(u32T0H > 0xFF)
    {
        u32T0H = 0xFF;
        llsi->DUTY |= (0xfful << (0));
    ...
    {
        llsi->DUTY = (llsi->DUTY & (~(0xfful << (0)))) | (u32T0H << (0));
    }

    u32T1H = ((u32ClkSrc * 10) / 1000000 * u32T1HTimeNsec / 1000 / (u32Div + 1) + 5) / 10;
    if(u32T1H > 0xFF)
    {
        u32T1H = 0xFF;
        llsi->DUTY |= (0xfful << (16));
    ...
    {
        llsi->DUTY = (llsi->DUTY & (~(0xfful << (16)))) | (u32T1H << (16));
    }

    u32ResetPeriod = ((u32ClkSrc * 10) / 1000000 * u32ResetTimeNsec / 1000 / (u32Div + 1) + 5) / 10;
    if(u32ResetPeriod > 0xFFFF)
    {
        u32ResetPeriod = 0xFFFF;
        llsi->RSTPERIOD |= (0xfffful << (0));
    }
    else
    {
        llsi->RSTPERIOD = (llsi->RSTPERIOD & (~(0xfffful << (0)))) | (u32ResetPeriod << (0));
    }
...
void LLSI_Close(LLSI_T *llsi)
{
    if(llsi == ((LLSI_T *) ((( uint32_t)0x40000000) + 0x54000)))
    {

        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 |= (0x1ul << (16));
        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 &= ~(0x1ul << (16));
    }
    else if(llsi == ((LLSI_T *) ((( uint32_t)0x40100000) + 0x54000)))
    {

        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 |= (0x1ul << (17));
        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 &= ~(0x1ul << (17));
    }
    else if(llsi == ((LLSI_T *) ((( uint32_t)0x40000000) + 0x54200)))
    {

        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 |= (0x1ul << (18));
        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 &= ~(0x1ul << (18));
    }
    else if(llsi == ((LLSI_T *) ((( uint32_t)0x40100000) + 0x54200)))
    {

        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 |= (0x1ul << (19));
        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 &= ~(0x1ul << (19));
    }
    else if(llsi == ((LLSI_T *) ((( uint32_t)0x40000000) + 0x54400)))
    {

        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 |= (0x1ul << (20));
        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 &= ~(0x1ul << (20));
    }
    else if(llsi == ((LLSI_T *) ((( uint32_t)0x40100000) + 0x54400)))
    {

        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 |= (0x1ul << (21));
        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 &= ~(0x1ul << (21));
    }
    else if(llsi == ((LLSI_T *) ((( uint32_t)0x40000000) + 0x54600)))
    {

        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 |= (0x1ul << (22));
        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 &= ~(0x1ul << (22));
    }
    else if(llsi == ((LLSI_T *) ((( uint32_t)0x40100000) + 0x54600)))
    {

        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 |= (0x1ul << (23));
        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 &= ~(0x1ul << (23));
    }
    else if(llsi == ((LLSI_T *) ((( uint32_t)0x40000000) + 0x54800)))
    {

        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 |= (0x1ul << (24));
        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 &= ~(0x1ul << (24));
    }
    else if(llsi == ((LLSI_T *) ((( uint32_t)0x40100000) + 0x54800)))
    {

        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 |= (0x1ul << (25));
        ((SYS_T *) ((( uint32_t)0x50000000) + 0x00000))->IPRST2 &= ~(0x1ul << (25));
    }
}
# 231 "../../../Library/StdDriver/src/llsi.c"
void LLSI_GetTimeInfo(LLSI_T *llsi, S_LLSI_TIME_INFO_T *sPt)
{
    ...
    g_u32DIVIDER = (llsi->CLKDIV & (0xfful << (0))) >> (0);
    g_u32PERIOD = (llsi->PERIOD & (0xfful << (0))) >> (0);
    g_u32T0H = (llsi->DUTY & (0xfful << (0))) >> (0);
    g_u32T1H = (llsi->DUTY & (0xfful << (16))) >> (16);
    g_u32RSTPERIOD = (llsi->RSTPERIOD & (0xfffful << (0))) >> (0);
...
# 262 "../../../Library/StdDriver/src/llsi.c"
void LLSI_SetFIFO(LLSI_T *llsi, uint32_t u32TxThreshold)
{
    llsi->CTL = (llsi->CTL & ~(0x3ul << (16))) | (u32TxThreshold << (16));
}
# 283 "../../../Library/StdDriver/src/llsi.c"
void LLSI_EnableInt(LLSI_T *llsi, uint32_t u32Mask)
{
...
# 326 "../../../Library/StdDriver/src/llsi.c"
void LLSI_DisableInt(LLSI_T *llsi, uint32_t u32Mask)
{
...
# 369 "../../../Library/StdDriver/src/llsi.c"
uint32_t LLSI_GetIntFlag(LLSI_T *llsi, uint32_t u32Mask)
{
    uint32_t u32IntFlag = 0;


    if((u32Mask & (0x001)) && (llsi->STATUS & (0x1ul << (4))))
        u32IntFlag |= (0x001);


    if((u32Mask & (0x002)) && (llsi->STATUS & (0x1ul << (5))))
        u32IntFlag |= (0x002);


    if((u32Mask & (0x004)) && (llsi->STATUS & (0x1ul << (0))))
        u32IntFlag |= (0x004);


    if((u32Mask & (0x008)) && (llsi->STATUS & (0x1ul << (1))))
        u32IntFlag |= (0x008);


    if((u32Mask & (0x010)) && (llsi->STATUS & (0x1ul << (2))))
        u32IntFlag |= (0x010);


    if((u32Mask & (0x020)) && (llsi->STATUS & (0x1ul << (3))))
        u32IntFlag |= (0x020);

    return u32IntFlag;
}
# 413 "../../../Library/StdDriver/src/llsi.c"
void LLSI_ClearIntFlag(LLSI_T *llsi, uint32_t u32Mask)
{
    if(u32Mask & (0x001))
        llsi->STATUS = (0x1ul << (4));
